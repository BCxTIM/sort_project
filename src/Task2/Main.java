...
/**
 * Created by tmoiseev on 7/31/2017.
 */
public class Main {
        ...
        public static void main(String[] args) {
            ...
            points.add(0, new PairDouble(1, 1));
            points.add(1, new PairDouble(4, 3));
            points.add(2, new PairDouble(2, 0));
            points.add(3, new PairDouble(2, 2));
            points.add(3, new PairDouble(4, 1));
            points.add(3, new PairDouble(3, 2));
            points.add(3, new PairDouble(3, 4));
            points.add(3, new PairDouble(1, 3));
            points.add(3, new PairDouble(2, 3));
